...
export function flightTelemetry(flight){
  ...
  return {altitudeM,altitudeKm:altitudeM/1000,speedMps:norm(velocity),airSpeedMps,verticalSpeedMps,horizontalSpeedMps,eastSpeedMps,northSpeedMps,dynamicPressurePa,mach,heatFluxWm2,downrangeKm,atmosphere,orbit,stageName:stage.name,stagePropellantKg:propellantKg,totalPropellantKg,fuelPct,massKg:flight.massKg,pitchDeg:flight.attitudeDeg.pitch,yawDeg:flight.attitudeDeg.yaw,rollDeg:flight.attitudeDeg.roll,gLoad:flight.lastTelemetry?.gLoad||1,thrustN:flight.lastTelemetry?.thrustN||0,targetPitchDeg:guidanceTarget(altitudeM)};
}
