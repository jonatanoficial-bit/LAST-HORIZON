...
export function createInitialState(seed = "HAVEN-2047", mode = "campaign") {
  ...
  return {
    meta:{saveVersion:14,build:"2026.08.10-first-flight-training",seed,createdAt:now,lastSavedAt:now,rngState:hashSeed(seed)},
