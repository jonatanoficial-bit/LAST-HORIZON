...
export function createInitialState(seed = "HAVEN-2047", mode = "campaign") {
  ...
  return {
    meta:{saveVersion:6,build:"2026.08.06-crew-operations",seed,createdAt:now,lastSavedAt:now,rngState:hashSeed(seed)},
    ...
    mission:{phase:"planejamento",route:{target:null,site:null,progress:0},checklists:{design:false,tests:false,crew:false,go:false},telemetry:[],alerts:[]},
