...
export function createInitialState(seed = "HAVEN-2047", mode = "campaign") {
  ...
  return {
    meta:{saveVersion:7,build:"2026.08.07-orbital-navigation",seed,createdAt:now,lastSavedAt:now,rngState:hashSeed(seed)},
    ...
    mission:{phase:"planejamento",route:{target:null,site:null,progress:0},checklists:{design:false,tests:false,crew:false,go:false},telemetry:[],alerts:[],orbit:{body:"Terra",status:"insertion",periapsisKm:168,apoapsisKm:220,inclinationDeg:28.5,meanAnomalyDeg:158,elapsedSeconds:0,propellantKg:14000,initialPropellantKg:14000,plannedNode:null,executed:[],windowToleranceDeg:6,lastBurn:null}},
