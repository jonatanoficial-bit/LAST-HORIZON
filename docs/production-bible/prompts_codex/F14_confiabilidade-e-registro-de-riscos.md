# PROMPT CODEX - F14 - Confiabilidade e registro de riscos - v1.4.0
...
- `src/sim/reliability.js`
- `src/sim/risk-register.js`
...
## Critérios de aceite
- Risco por sistema
- Evidências alteram confiança
- Seed reproduz falhas
