...
test("the six delivered MP4 files are present, valid containers and GitHub-safe",async()=>{
...
test("mission code maps every delivered cinematic to its physical event",async()=>{
  const app=await readFile(new URL("src/app.js",root),"utf8");
  for(const id of ["launch_ignition","launch_maxq","stage_separation","orbit_insertion","departure_burn","docking_success"])
