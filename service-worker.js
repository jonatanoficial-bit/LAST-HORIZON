const CACHE="last-horizon-4.6.0-flightdeck";
...
const CORE=["./","./index.html","./404.html","./manifest.webmanifest","./version.json?v=4.6.0","./styles/tokens.css","./styles/base.css","./styles/layout.css","./styles/components.css","./styles/screens.css?v=4","./styles/accessibility.css","./src/app.js","./src/core/store.js","./src/core/rng.js","./src/data/save-manager.js","./src/sim/simulation.js","./src/ui/router.js","./data/game.json","./data/locales.json?v=4.6.0","./data/story.json?v=4.6.0","./assets/video/video-manifest.json?v=4.6.0","./assets/video/flight-manifest.json?v=4.6.0","./assets/icons/icon.svg","./assets/images/brand/bg-main-menu-earth-orbit.webp","./assets/images/brand/bg-main-menu-earth-orbit.png",...MEDIA];
